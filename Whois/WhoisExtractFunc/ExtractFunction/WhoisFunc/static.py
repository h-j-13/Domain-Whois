...
path_shelve_file = root_path + 'data_get/shelve_file'
path_server_not_found = root_path + 'data_get/.server_not_found'
...
try:
    ...
    TABLE_SVR_IP = conf.get('whois服务器ip地址表', 'TABLE_SVR_IP')
    DATABASE_WHOIS = conf.get('whois基础数据库名', 'DATABASE_WHOIS')
except Exception, e:
...
server_not_found = data_get.get_server_not_found.ServerNotFound() # not_found标志获取对象