...
sys.path.append('..')
logging.config.fileConfig(os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir)) + "/logger.conf")
...
def get_status_value(status_str, domain):
    ...
    for status in infos:
        ...
        if status_value == '0':
            logger.warning('domain: ' + domain + ' dommain_status->error_value: ' + status)
...
if __name__ == '__main__':
    ...
    print get_status_value('ACTIVE,PENDINGDeLETE', 'baidu.com')
